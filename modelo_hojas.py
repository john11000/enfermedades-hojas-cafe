...
Miner_folder = os.path.join(image_folder, "Miner")
Rust_folder = os.path.join(image_folder, "Rust")


Miner_path = os.path.join(Miner_folder, "*.jpg")
Rust_path = os.path.join(Rust_folder, "*.jpg")
...
# print(len(ripe_filenames), len(unripe_filenames))
...
# print( len(df_ripe), len(df_unripe))
...
tuner = kt.Hyperband(
    ...
    factor=3,
    overwrite=False,
    directory='/home/usco/Documents/datasetcoffe/my_direc',
...
model_save_path = "/home/usco/Documents/datasetcoffe/model2.h5"
